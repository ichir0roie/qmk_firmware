...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
		...
		KC_LGUI,KC_GRV,KC_LALT,KC_LCTL,LSFT_T(KC_SPC),LT(2,KC_BSPC),KC_LGUI,
		JP_BSLS,JP_UNDS,JP_LPRN,JP_LCBR,JP_LBRC,JP_AT,KC_INS,
		KC_Y,KC_U,KC_I,KC_O,KC_P,JP_EQL,KC_DEL,
		KC_H,KC_J,KC_K,KC_L,JP_SCLN,JP_COLN,KC_ENT,
		KC_N,KC_M,KC_COMM,KC_DOT,JP_SLSH,LGUI(KC_TAB),MO(1),
		LT(1,KC_GRV),LSFT_T(KC_ENT),KC_RCTL,KC_RALT,KC_APP,KC_RGUI,KC_RGUI
    )
,    [1] = LAYOUT(
