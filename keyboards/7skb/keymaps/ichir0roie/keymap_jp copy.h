#define JP_ASTR S(JP_COLN) // * //1
#define JP_PLUS S(JP_SCLN) // + //2
...
#define JP_LPRN S(JP_8)    // ( // 8
#define JP_LCBR S(JP_LBRC) // { // 9
...
#define JP_HASH S(JP_3)    // # // l6

#define JP_BSLS KC_INT1    // \ // r5
#define JP_UNDS S(JP_BSLS) // _ // r6

#define JP_YEN  KC_INT3    // ¥ // r5
