...
#define MOUSEKEY_MAX_SPEED 100 // 10 /* Maximum cursor speed at which acceleration stops */
#define MOUSEKEY_TIME_TO_MAX 30 // 20 /* Time until maximum cursor speed is reached */
