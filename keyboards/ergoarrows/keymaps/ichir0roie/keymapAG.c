...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(JP_AT, JP_ASTR, JP_PLUS, JP_MINS, JP_DQUO, JP_UNDS, KC_CAPS, KC_SLCK, JP_BSLS, JP_QUOT, JP_LPRN, JP_LCBR, JP_LBRC, JP_HASH, KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_PAUS, KC_PSCR, KC_Y, KC_U, KC_I, KC_O, KC_P, JP_EQL, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_NLCK, KC_INS, KC_H, KC_J, KC_K, KC_L, JP_SCLN, JP_COLN, MO(1), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_BSPC, KC_DEL, KC_N, KC_M, KC_COMM, KC_DOT, JP_SLSH, MO(1), KC_LGUI, KC_ENT, KC_LALT, KC_LCTL, KC_LSFT, MO(2), MO(3), KC_ENT, KC_SPC, KC_LSFT, KC_RCTL, KC_RALT, KC_APP, KC_GRV, LGUI(KC_V), LCA(KC_V), LGUI(LSFT(JP_S)), LGUI(LCTL(KC_LEFT)), LGUI(KC_TAB), LGUI(LCTL(KC_RGHT))),
	...
	[2] = LAYOUT(TO(0), KC_1, KC_2, KC_3, KC_4, KC_5, KC_NO, KC_NO, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_DEL, KC_NLCK, KC_P7, KC_P8, KC_P9, JP_EQL, KC_NO, KC_NO, KC_NO, KC_NO, LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_RGHT)), LGUI(KC_TAB), KC_NO, KC_BSPC, KC_P0, KC_P4, KC_P5, KC_P6, JP_SLSH, KC_NO, KC_NO, KC_APP, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_NO, KC_ENT, KC_PDOT, KC_P1, KC_P2, KC_P3, JP_COLN, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_NO, KC_LGUI, KC_NO, KC_LALT, KC_LCTL, KC_LSFT, KC_TRNS, KC_NO, KC_ENT, KC_SPC, KC_RSFT, KC_RCTL, KC_RALT, KC_NO, KC_RGUI, RCTL(KC_X), RCTL(KC_C), RCTL(KC_V), KC_NO, KC_NO, KC_NO),
