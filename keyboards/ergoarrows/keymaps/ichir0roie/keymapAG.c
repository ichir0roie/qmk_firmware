...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(JP_AT, JP_ASTR, JP_PLUS, JP_MINS, JP_DQUO, JP_UNDS, KC_CAPS, KC_SLCK, JP_BSLS, JP_QUOT, JP_LPRN, JP_LCBR, JP_LBRC, JP_HASH, KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_PAUS, KC_PSCR, KC_Y, KC_U, KC_I, KC_O, KC_P, JP_EQL, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_NLCK, KC_INS, KC_H, KC_J, KC_K, KC_L, JP_SCLN, JP_COLN, KC_ENT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_BSPC, KC_DEL, KC_N, KC_M, KC_COMM, KC_DOT, JP_SLSH, KC_APP, KC_LGUI, MO(1), KC_LALT, KC_LCTL, KC_LSFT, MO(2), MO(3), KC_ENT, KC_SPC, KC_LSFT, KC_RCTL, KC_RALT, MO(1), KC_GRV, LGUI(KC_V), LCA(KC_V), LGUI(LSFT(JP_S)), LGUI(LCTL(KC_LEFT)), LGUI(KC_TAB), LGUI(LCTL(KC_RGHT))),
