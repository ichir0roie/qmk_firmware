...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, LGUI(LCTL(KC_LEFT)), LGUI(KC_TAB), LGUI(LCTL(KC_RGHT)), KC_H, KC_J, KC_K, KC_L, JP_SCLN, JP_COLN,
        KC_APP, KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_INS, KC_DEL, KC_N, KC_M, KC_COMM, KC_DOT, JP_SLSH, KC_RGUI, KC_APP,
    ...
    [1] = LAYOUT(
        ...
        KC_NO, KC_ENT, KC_PDOT, KC_P1, KC_P2, KC_P3, JP_COLN, KC_INS, KC_DEL, KC_NO, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_NO, KC_NO,
