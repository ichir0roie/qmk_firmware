...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_INS, KC_LEFT, KC_RIGHT, KC_DEL, KC_N, KC_M, KC_COMM, KC_DOT, JP_SLSH, KC_RGUI,
    ...
    [1] = LAYOUT(
        ...
        KC_ENT, KC_PDOT, KC_P1, KC_P2, KC_P3, JP_COLN, KC_BSPC, KC_LGUI, KC_RGUI, KC_DEL, KC_NO, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_RGUI,
